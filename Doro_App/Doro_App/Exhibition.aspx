<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Exhibition.aspx.cs"
  Inherits="Doro_App.Community" %>
        ...
        <div class="container">
          <div class="row">
            ...
            <%--DataSourceID="SqlDataSource1"--%>
              <br />
              <asp:DataList ID="DataList1" class="col-lg-12" runat="server" DataSourceID="SqlDataSource1"
                RepeatColumns="3" CellSpacing="10" CellPadding="20" RepeatDirection="Horizontal" Width="1200px">
                <ItemTemplate>
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server"
                ...
                SelectCommand="SELECT [DrawingDescription], [DrawingId], [DrawingName], [Drawing] FROM [Drawing]">
