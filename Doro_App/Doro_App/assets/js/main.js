...
(function($) {
  ...
  /*--/ Navbar Collapse /--*/
  //  $('.navbar-toggle-box-collapse-search').on('click', function() {
  //      $('body').removeClass('box-collapsesearch-search-closed').addClass('box-collapse-search-open');
  //});
  //  $('.close-box-collapse-search, .click-closed-search').on('click', function() {
  //    $('body').removeClass('box-collapse-search-open').addClass('box-collapse-search-closed');
  //  $('.menu-list ul').slideUp(700);
  //});
    $('navbar-toggle-box-collapse-login').on('click',function () {
        $('#loginModal').modal('show');
      
    });
    $('.close-box-collapse, .close').on('click', function () {
