<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="EditProfile.aspx.cs"
    Inherits="Doro_App.EditProfile" %>
                ...
                <div runat="server"
                    ...
                    <LayoutTemplate>
                        <table cellpadding="1" cellspacing="0" style="border-collapse:collapse;">
                                        ...
                                        <tr>
                                            <td align="center" class="auto-style8">
                                                <asp:Label ID="UserNameLabel" runat="server"
                                                    AssociatedControlID="UserName"><strong>User Name:</strong>
                                                </asp:Label>
                                            </td>
                                        ...
                                        <tr>
                                            <td align="center" class="auto-style8">
                                                <asp:Label ID="PasswordLabel" runat="server"
                                                    AssociatedControlID="Password"><strong>Password:</strong>
                                                </asp:Label>
                                            </td>
                                            <td class="auto-style5">
                                            ...
                                            <td class="auto-style1">
                                                <asp:RequiredFieldValidator ID="PasswordRequired" runat="server"
                                                    ...
                                                    ToolTip="Password is required." ValidationGroup="update"
                                                    Display="Dynamic">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="auto-style1">
                                                <asp:RequiredFieldValidator ID="EmailRequired" runat="server"
                                                    ...
                                                    ToolTip="Email is required." ValidationGroup="update"
                                                    Display="Dynamic">*</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <%--<tr>
                                            <td align="center" class="auto-style8">
                                                <asp:Label ID="BirthdayLabel" runat="server"
                                                    AssociatedControlID="BirthData"><strong>Birthday:</strong>
                                                </asp:Label>
                                            </td>
                                            <td class="auto-style5">
                                                <asp:TextBox ID="BirthData" class="form-control" runat="server"
                            ...
                            <tr>
                                <td align="center" class="auto-style8">
                                    <asp:Label ID="BioLabel" runat="server" AssociatedControlID="Bio">
                                        <strong>Bio:</strong></asp:Label>
                                </td>
                                <td class="auto-style5">
                                    <asp:TextBox ID="Bio" class="form-control" TextMode="multiline" runat="server"
                                        maxlength="1200" lines="10" cols="10" wrap="true" Width="300px"></asp:TextBox>
                                ...
                                <td class="auto-style1">
                                    <%-- <asp:RequiredFieldValidator ID="BirthdayRequired" runat="server"
                                        ...
                                        ToolTip="Birthday is required." ValidationGroup="update" Display="Dynamic">*
                            ...
                            <tr>
                                <td align="center" colspan="3">
                                    <asp:Button ID="update" class="btn btn-b-n d-none d-md-block" runat="server"
                                        Text="Update" ValidationGroup="update" OnClick="update_Click" />
                                </td>
                            </tr>
